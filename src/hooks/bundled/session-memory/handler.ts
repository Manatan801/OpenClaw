...
const saveSessionToMemory: HookHandler = async (event) => {
  ...
  try {
    ...
    log.debug("Current sessionId:", { sessionId: currentSessionId });
    log.debug("Current sessionFile:", { sessionFile: currentSessionFile });
    log.debug("cfg present:", { present: !!cfg });
    ...
    if (sessionFile) {
      ...
      log.debug("sessionContent length:", {
    ...
    log.debug("Full path:", { path: memoryFilePath });
